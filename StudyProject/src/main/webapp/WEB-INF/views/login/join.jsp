    ...
    <main>
        ...
        <div class="col">
            ...
            <div class="col-12">
                ...
                <div class="input-group has-validation" id="idArea">
            ...
            <div class="col-12">
                ...
                <div class="has-validation">
                    <input type="password" class="form-control" id="passwd" name="passwd" placeholder="8~20자리 비밀번호" required>
                <div class="invalid-feedback">
                    Your username is required.
                </div>
                </div>
            ...
            <div class="col-12">
                <label for="isPasswd" class="form-label">비밀번호 확인</label>
            <div class="has-validation">
                <input type="password" class="form-control" id="isPasswd" placeholder="8~20자리 비밀번호" required>
            <div class="invalid-feedback">
                Your username is required.
                </div>
            </div>
